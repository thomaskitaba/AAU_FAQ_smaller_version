...
test_cases = [
...

    {
        ...
        "purpose": "Tests whether the system can infer the correct location even when the question is phrased in a slightly different or indirect way."
    },

    {
        ...
        "purpose": "Tests robustness when key terms are missing or replaced with more general phrasing (e.g., 'previous score' instead of UAT result)."
    },

    {
        ...
        "purpose": "Tests semantic understanding when the question is reworded but keeps the same meaning as the FAQ."
    }
]
...
def run_evaluation():
    ...
    for item in test_cases:
        ...
        results_summary.append({
            ...
            "score": score,
            "correct": is_correct,
            "evaluation_level": item.get("evaluation_level", "N/A"),
            "evaluation_name": item.get("evaluation_name", "N/A"),
...
if st.sidebar.button("Run Evaluation"):
    ...
    for r in results_summary:
        ...
        st.markdown(f"============================")
        st.markdown(f"- Evaluation Level: {r.get('evaluation_level', 'N/A')}")
        st.markdown(f"- Evaluation Name: {r.get('evaluation_name', 'N/A')}")
        st.markdown(f"- Purpose: {r.get('purpose', 'N/A')}")
        st.markdown("---")
